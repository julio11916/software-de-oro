...
--
-- Name: orden_personalizada; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.orden_personalizada OWNER TO postgres;

--
-- Name: orden_personalizada_id_orden_personalizada_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.orden_personalizada_id_orden_personalizada_seq OWNER TO postgres;

--
-- Name: orden_personalizada_id_orden_personalizada_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: orden_personalizada_precio; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.orden_personalizada_precio OWNER TO postgres;
...
--
-- Name: orden_personalizada id_orden_personalizada; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: orden_personalizada; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: orden_personalizada_precio; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: orden_personalizada orden_personalizada_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: orden_personalizada_precio orden_personalizada_precio_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
